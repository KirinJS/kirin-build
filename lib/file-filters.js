...
exports.nonBrowserfiableJavascript = function (f) {
    return exports.allJavascript(f) && !browserfiable(f) && !stub.test(f);
};

exports.nonBrowserfiable = function (f) {
    return (!browserfiable(f) || exports.nonCode(f)) && !stub.test(f);
};
