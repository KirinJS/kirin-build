...
exports.discoverDeep = function (packageLocation, argv, mockPackageJson) {
    var packages = exports.discover(packageLocation, mockPackageJson);
...
Package.prototype.discover = function (mockPackageJson) {
    ...
    exports.rootPackageName = exports.rootPackageName || self.name;
...
Package.prototype.crawl = function (argv_) {
    ...
    _.each(files, function (filepath) {
        ...
        if (!fs.existsSync(filepath) || fsHelper.isDirectory(filepath)) {
            return;
        }
